// Wagon body shader: textured wood that takes the sun's terrain and self shadows
// and distance fog, the same way the hay bales and horses do. Eye-space position
// + normal + texture UV are passed to the fragment stage; the shadow maps are
// sampled there with the exact same uniforms as the terrain shader.
